...
ActiveRecord::Schema.define(version: 20170428201230) do
  ...
  add_index "employee_project_communications", ["employee_id"], name: "index_employee_project_communications_on_employee_id", using: :btree
  add_index "employee_project_communications", ["project_id"], name: "index_employee_project_communications_on_project_id", using: :btree
  ...
  add_foreign_key "employee_project_communications", "employees"
  add_foreign_key "employee_project_communications", "projects"
